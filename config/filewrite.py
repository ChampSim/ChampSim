...
def generate_module_information(containing_dir, module_info):
    ...
    yield os.path.join(containing_dir, 'module_def.inc'), ('#ifndef GENERATED_MODULES_INC', '#define GENERATED_MODULES_INC', '#include "modules.h"', 'namespace champsim::modules::generated','{')
...
def get_file_lines(parsed_config, bindir_name, srcdir_names, objdir_name, omit_main):
    '''
    ...
    yield makefile_file_name, get_makefile_lines(unique_obj_dir, build_id, executable, srcdir_names, joined_module_info, omit_main)
...
class FileWriter:
    ...
    def write_files(self, parsed_config, bindir_name=None, srcdir_names=None, objdir_name=None, omit_main=False):
        ...
        file_lines = get_file_lines(parsed_config, local_bindir_name, local_srcdir_names, local_objdir_name, omit_main)
        self.fileparts.extend(file_lines)
