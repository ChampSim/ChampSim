...
def get_cache_module_lines(pref_data, repl_data):
    ...
    pref_nonbranch_variant_data = [
        ...
        ('prefetcher_cache_operate', (('champsim::address', 'addr'), ('champsim::address', 'ip'), ('uint8_t', 'cache_hit'), ('uint8_t', 'type'), ('uint32_t', 'metadata_in')), 'uint32_t', 'std::bit_xor'),
        ('prefetcher_cache_fill', (('champsim::address', 'addr'), ('uint32_t', 'set'), ('uint32_t', 'way'), ('uint8_t', 'prefetch'), ('champsim::address', 'evicted_addr'), ('uint32_t', 'metadata_in')), 'uint32_t', 'std::bit_xor'),
