...
long PageTableWalker::operate()
{
  ...
  std::for_each(complete_begin, complete_end, [](auto& mshr_entry) {
    channel_type::response_type response{mshr_entry.v_address, mshr_entry.v_address, mshr_entry.data.value(), mshr_entry.pf_metadata, mshr_entry.instr_depend_on_me};
