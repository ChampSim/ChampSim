...
void O3_CPU::impl_last_branch_result(uint64_t ip, uint64_t target, bool taken, uint8_t branch_type)
{
...
void O3_CPU::impl_update_btb(uint64_t ip, uint64_t predicted_target, bool taken, uint8_t branch_type)
{
