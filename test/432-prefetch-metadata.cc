...
SCENARIO("Prefetch metadata from an issued prefetch is seen in the lower level") {
  GIVEN("An upper and lower level pair of caches") {
    ...
    champsim::NonTranslatingQueues lower_queues{1, 32, 32, 32, 0, LOG2_BLOCK_SIZE, false};
    champsim::NonTranslatingQueues upper_queues{1, 32, 32, 32, 0, LOG2_BLOCK_SIZE, false};
