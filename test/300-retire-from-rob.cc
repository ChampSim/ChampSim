...
SCENARIO("Completed instructions are retired") {
  ...
  GIVEN("A ROB with a single instruction") {
    ...
    uut.ROB.push_back(ooo_model_instr{input_instr{}});
  ...
  GIVEN("A ROB with two instructions") {
    ...
    std::vector test_instructions( retire_bandwidth, ooo_model_instr{input_instr{}} );
  ...
  GIVEN("A ROB with twice as many instructions as retire bandwidth") {
    ...
    std::vector test_instructions( 2*retire_bandwidth, ooo_model_instr{input_instr{}} );
