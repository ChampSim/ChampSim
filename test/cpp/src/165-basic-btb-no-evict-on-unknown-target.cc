...
TEST_CASE("The basic_btb does not fill not-taken branches")
{
  ...
  std::array<champsim::address, 8> seed_ip{{champsim::address{0x110000}, champsim::address{0x111000}, champsim::address{0x112000}, champsim::address{0x113000},
                                            champsim::address{0x114000}, champsim::address{0x115000}, champsim::address{0x116000},
                                            champsim::address{0x117000}}};
  ...
  CHECK_THAT(seed_check_result, Catch::Matchers::AllMatch(Catch::Matchers::Predicate<std::pair<champsim::address, bool>>(
