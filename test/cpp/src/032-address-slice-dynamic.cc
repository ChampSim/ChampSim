...
TEST_CASE("Dynamically-sized address sliced can be re-sliced")
{
  ...
  REQUIRE(champsim::address_slice{champsim::dynamic_extent{20_b, 8_b}, addr}.slice(champsim::dynamic_extent{8_b, 2_b})
          == champsim::address_slice{champsim::dynamic_extent{16_b, 10_b}, addr});
}
...
{
  auto ext = GENERATE(
      as<champsim::dynamic_extent>{}, champsim::dynamic_extent{8_b, 4_b}, champsim::dynamic_extent{12_b, 4_b}, champsim::dynamic_extent{16_b, 4_b},
      champsim::dynamic_extent{20_b, 4_b}, champsim::dynamic_extent{24_b, 4_b}, champsim::dynamic_extent{28_b, 4_b}, champsim::dynamic_extent{12_b, 8_b},
      champsim::dynamic_extent{16_b, 8_b}, champsim::dynamic_extent{20_b, 8_b}, champsim::dynamic_extent{24_b, 8_b}, champsim::dynamic_extent{28_b, 8_b},
      ...
      champsim::dynamic_extent{20_b, 16_b}, champsim::dynamic_extent{24_b, 16_b}, champsim::dynamic_extent{28_b, 16_b}, champsim::dynamic_extent{24_b, 20_b},
      champsim::dynamic_extent{28_b, 20_b}, champsim::dynamic_extent{28_b, 24_b});
  champsim::address_slice lhs{champsim::dynamic_extent{32_b, 0_b}, 0xaaaa'aaaa};
  champsim::address_slice rhs{ext, 0xbbbb'bbbb};

  REQUIRE(champsim::splice(lhs, rhs)
          == champsim::address_slice{champsim::dynamic_extent{32_b, 0_b}, champsim::splice_bits(0xaaaa'aaaa, 0xbbbb'bbbb, ext.upper, ext.lower)});
}
