...
{
  STATIC_REQUIRE(
      std::is_constructible_v<champsim::address_slice<champsim::static_extent<20_b, 16_b>>, champsim::address_slice<champsim::static_extent<24_b, 12_b>>>);
...
TEMPLATE_TEST_CASE_SIG("An address slice is constexpr constructible from a wider address_slice", "", ((uint64_t ADDR), ADDR), 0x1234'5678'90ab'cdef, 0xabababab,
...
{
  STATIC_REQUIRE(
      std::is_constructible_v<champsim::address_slice<champsim::static_extent<20_b, 16_b>>, champsim::address_slice<champsim::static_extent<24_b, 16_b>>>);
...
{
  STATIC_REQUIRE(
      std::is_constructible_v<champsim::address_slice<champsim::static_extent<20_b, 16_b>>, champsim::address_slice<champsim::static_extent<20_b, 12_b>>>);
...
{
  STATIC_REQUIRE(
      std::is_constructible_v<champsim::address_slice<champsim::static_extent<24_b, 12_b>>, champsim::address_slice<champsim::static_extent<20_b, 16_b>>>);
...
{
  STATIC_REQUIRE(champsim::is_detected_v<::cmp_slice, champsim::address_slice<champsim::static_extent<16_b, 8_b>>,
                                         champsim::address_slice<champsim::static_extent<16_b, 8_b>>>);
...
TEST_CASE("Statically sized address slices can compare equal even if the underlying addresses differ outside the slice")
{
  ...
  REQUIRE_FALSE(champsim::address_slice{champsim::static_extent<20_b, 12_b>{}, addr_a}
                != champsim::address_slice{champsim::static_extent<20_b, 12_b>{}, addr_b});
  ...
  REQUIRE_FALSE(champsim::address_slice{champsim::static_extent<24_b, 16_b>{}, addr_a}
                != champsim::address_slice{champsim::static_extent<24_b, 16_b>{}, addr_b});
  ...
  REQUIRE_FALSE(champsim::address_slice{champsim::static_extent<28_b, 20_b>{}, addr_a}
                != champsim::address_slice{champsim::static_extent<28_b, 20_b>{}, addr_b});
...
{
  STATIC_REQUIRE_FALSE(champsim::is_detected_v<::cmp_slice, champsim::address_slice<champsim::static_extent<20_b, 16_b>>,
                                               champsim::address_slice<champsim::static_extent<10_b, 6_b>>>);
  STATIC_REQUIRE_FALSE(champsim::is_detected_v<::cmp_slice, champsim::address_slice<champsim::static_extent<20_b, 16_b>>,
                                               champsim::address_slice<champsim::static_extent<20_b, 6_b>>>);
  STATIC_REQUIRE_FALSE(champsim::is_detected_v<::cmp_slice, champsim::address_slice<champsim::static_extent<20_b, 16_b>>,
                                               champsim::address_slice<champsim::static_extent<30_b, 16_b>>>);
}
...
TEST_CASE("Statically-sized address slices can be re-sliced")
{
  ...
  REQUIRE(champsim::address_slice{champsim::static_extent<20_b, 8_b>{}, addr}.slice(champsim::static_extent<8_b, 2_b>{})
          == champsim::address_slice{champsim::static_extent<16_b, 10_b>{}, addr});
  REQUIRE(champsim::address_slice{champsim::static_extent<20_b, 8_b>{}, addr}.slice<8_b, 2_b>()
          == champsim::address_slice{champsim::static_extent<16_b, 10_b>{}, addr});
}
...
TEMPLATE_TEST_CASE_SIG("Address slices with adjacent indices can be spliced", "", ((champsim::data::bits V, champsim::data::bits W), V, W), (8_b, 4_b),
                       (12_b, 4_b), (16_b, 4_b), (20_b, 4_b), (24_b, 4_b), (28_b, 4_b), (12_b, 8_b), (16_b, 8_b), (20_b, 8_b), (24_b, 8_b), (28_b, 8_b),
                       (16_b, 12_b), (20_b, 12_b), (24_b, 12_b), (28_b, 12_b), (20_b, 16_b), (24_b, 16_b), (28_b, 16_b), (24_b, 20_b), (28_b, 20_b),
                       (28_b, 24_b))
{
...
TEMPLATE_TEST_CASE_SIG("Address slices that are subsets can be spliced", "", ((champsim::data::bits V, champsim::data::bits W), V, W), (8_b, 4_b), (12_b, 4_b),
