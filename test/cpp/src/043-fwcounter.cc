...
TEMPLATE_PRODUCT_TEST_CASE("A fixed-width counter is constructible by certian means", "",
                           (std::is_default_constructible, std::is_copy_constructible, std::is_move_constructible, std::is_copy_assignable,
                            std::is_move_assignable, std::is_destructible, std::is_swappable),
