...
struct first_level_exclusive : champsim::modules::state_model {
  ...
  explicit first_level_exclusive(CACHE* cache);
  first_level_exclusive(CACHE* cache, long sets, long ways);
