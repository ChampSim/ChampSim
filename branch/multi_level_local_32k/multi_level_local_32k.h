#ifndef BRANCH_MULTI_LEVEL_LOCAL_32K_H
#define BRANCH_MULTI_LEVEL_LOCAL_32K_H
...
// TODO: finish struct
struct multi_level_local_32k : champsim::modules::branch_predictor {
    
    // based on values used in modern processors

    [[nodiscard]] static constexpr auto hash(champsim::address ip) { return (ip.to<unsigned long>() >> 8) % PRIME; }
    
    // local history predictor
    static constexpr std::size_t LOCAL_HISTORY_LENGTH = 10;
    static constexpr std::size_t LOCAL_HISTORY_TABLE_SIZE = 8192;
    ...
    static constexpr std::size_t GLOBAL_PREDICTION_TABLE_SIZE = 16276;
    ...
    // selector predictor
    static constexpr std::size_t SELECTOR_PREDICTION_TABLE_SIZE = 16276;
