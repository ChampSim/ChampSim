...
class PageTableWalker : public champsim::operable, public MemoryRequestConsumer, public MemoryRequestProducer
{
	...
	PageTableWalker(string v1, unsigned fill_level, uint32_t v2, uint32_t v3, uint32_t v4, uint32_t v5, uint32_t v6, uint32_t v7, uint32_t v8, uint32_t v9, uint32_t v10, uint32_t v11, uint32_t v12, uint32_t v13, MemoryRequestConsumer* ll) : champsim::operable(1), MemoryRequestConsumer(fill_level), MemoryRequestProducer(ll), NAME(v1), VAL_PSCL5_SET(v2), VAL_PSCL5_WAY(v3),  VAL_PSCL4_SET(v4), VAL_PSCL4_WAY(v5), VAL_PSCL3_SET(v6), VAL_PSCL3_WAY(v7), VAL_PSCL2_SET(v8), VAL_PSCL2_WAY(v9), RQ_SIZE(v10), MSHR_SIZE(v11), MAX_READ(v12), MAX_FILL(v13) 
	{
