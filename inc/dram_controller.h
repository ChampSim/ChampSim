...
constexpr std::size_t DRAM_WRITE_HIGH_WM         = (DRAM_WQ_SIZE * (7/8)); // 7/8th
constexpr std::size_t DRAM_WRITE_LOW_WM          = (DRAM_WQ_SIZE * (6/8)); // 6/8th
constexpr std::size_t MIN_DRAM_WRITES_PER_SWITCH = (DRAM_WQ_SIZE * (1/4));
