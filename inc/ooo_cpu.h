...
public:
  ...
  champsim::bandwidth::maximum_type DIB_MAX_READ, FETCH_WIDTH, DECODE_WIDTH, DISPATCH_WIDTH, SCHEDULER_SIZE, EXEC_WIDTH, DIB_INORDER_WIDTH;
...
#include "ooo_cpu_module_decl.inc"
  ...
  explicit O3_CPU(champsim::core_builder<champsim::core_builder_module_type_holder<Bs...>, champsim::core_builder_module_type_holder<Ts...>> b)
      : champsim::operable(b.m_clock_period), cpu(b.m_cpu),
        ...
        ROB_SIZE(b.m_rob_size), SQ_SIZE(b.m_sq_size), DIB_HIT_BUFFER_SIZE(b.m_dib_hit_buffer_size), DIB_MAX_READ(b.m_dib_max_read), FETCH_WIDTH(b.m_fetch_width),
