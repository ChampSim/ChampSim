...
const auto default_l1i = champsim::cache_builder<champsim::cache_builder_module_type_holder<no>, champsim::cache_builder_module_type_holder<lru>, champsim::cache_builder_module_type_holder<exclusive>>{}
                             .sets_factor(64)
                             .ways(8)
                             .pq_size(32)
                             .hit_latency(3)
...
const auto default_l1d = champsim::cache_builder<champsim::cache_builder_module_type_holder<no>, champsim::cache_builder_module_type_holder<lru>, champsim::cache_builder_module_type_holder<exclusive>>{}
                             .sets_factor(64)
                             .ways(12)
                             .pq_size(8)
                             .hit_latency(4)
...
const auto default_l2c = champsim::cache_builder<champsim::cache_builder_module_type_holder<no>, champsim::cache_builder_module_type_holder<lru>, champsim::cache_builder_module_type_holder<exclusive>>{}
                             .sets_factor(512)
                             .ways(8)
                             .pq_size(16)
                             .hit_latency(9)
...
const auto default_itlb = champsim::cache_builder<champsim::cache_builder_module_type_holder<no>, champsim::cache_builder_module_type_holder<lru>, champsim::cache_builder_module_type_holder<exclusive>>{}
                              .sets_factor(16)
                              .ways(4)
                              .pq_size(0)
                              .hit_latency(1)
...
const auto default_dtlb = champsim::cache_builder<champsim::cache_builder_module_type_holder<no>, champsim::cache_builder_module_type_holder<lru>, champsim::cache_builder_module_type_holder<exclusive>>{}
                              .sets_factor(16)
                              .ways(4)
                              .pq_size(0)
                              .mshr_size(8)
...
const auto default_stlb = champsim::cache_builder<champsim::cache_builder_module_type_holder<no>, champsim::cache_builder_module_type_holder<lru>, champsim::cache_builder_module_type_holder<exclusive>>{}
                              .sets_factor(64)
                              .ways(12)
                              .pq_size(0)
                              .hit_latency(7)
...
const auto default_llc = champsim::cache_builder<champsim::cache_builder_module_type_holder<no>, champsim::cache_builder_module_type_holder<lru>, champsim::cache_builder_module_type_holder<exclusive>>{}
                             .name("LLC")
                             .sets_factor(2048)
                             .ways(16)
                             .pq_size(32)
