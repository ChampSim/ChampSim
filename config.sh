...
def write_files(iterable):
    ...
    for build_id, build in ids.items():
        ...
        inc_dir = os.path.join(objdir_name, build_id, 'inc')
        ...
        makefile_parts.append(makefile.get_makefile_string(objdir_name, build_id, os.path.join(bindir_name, executable), module_info, env))
...
if __name__ == '__main__':
    ...
    parsed_test = (*parse_config({'executable_name': '000-test-main'}, default_root), 'test', 'test')
