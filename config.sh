...
with open('_configuration.mk', 'wt') as wfp:
    wfp.write('generated_files = ' + ' '.join(generated_files) + '\n\n')
    wfp.write(makefile.get_makefile_string(module_info, **config_file))
