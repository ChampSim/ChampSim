...
ptw_fmtstr = 'PageTableWalker {name}("{name}", {cpu}, {fill_level}, {{{pscl5_set}, {pscl5_way}, vmem.shamt(5)}}, {{{pscl4_set}, {pscl4_way}, vmem.shamt(4)}}, {{{pscl3_set}, {pscl3_way}, vmem.shamt(3)}}, {{{pscl2_set}, {pscl2_way}, vmem.shamt(2)}}, {ptw_rq_size}, {ptw_mshr_size}, {ptw_max_read}, {ptw_max_write}, 0, {lower_level}, vmem);\n'
