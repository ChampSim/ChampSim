...
ptw_fmtstr = 'PageTableWalker {name}("{name}", {cpu}, {fill_level}, PagingStructureCache{{4, {pscl5_set}, {pscl5_way}, vmem.shamt(5)}}, PagingStructureCache{{3, {pscl4_set}, {pscl4_way}, vmem.shamt(4)}}, PagingStructureCache{{2, {pscl3_set}, {pscl3_way}, vmem.shamt(3)}}, PagingStructureCache{{1, {pscl2_set}, {pscl2_way}, vmem.shamt(2)}}, {ptw_rq_size}, {ptw_mshr_size}, {ptw_max_read}, {ptw_max_write}, 0, {lower_level}, vmem);\n'
